...
export const DEMO_PROFILE: Profile = {
  ...
  summary: "Product-minded full-stack engineer with 5+ years building SaaS platforms. Experienced in React, TypeScript, Node.js, and cloud infrastructure. Passionate about developer tooling and automation.",
  skills: {
